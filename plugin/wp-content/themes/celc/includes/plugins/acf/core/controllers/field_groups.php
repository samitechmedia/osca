...
<div class="acf-column-2">
	<div class="wp-box">
		<div class="inner">
			...
			<ul>
				<li><a href="http://www.advancedcustomfields.com/resources/#getting-started" rel="noreferrer" target="_blank"><?php _e("Getting Started",'acf'); ?></a></li>
				<li><a href="http://www.advancedcustomfields.com/resources/#field-types" rel="noreferrer" target="_blank"><?php _e("Field Types",'acf'); ?></a></li>
				<li><a href="http://www.advancedcustomfields.com/resources/#functions" rel="noreferrer" target="_blank"><?php _e("Functions",'acf'); ?></a></li>
				<li><a href="http://www.advancedcustomfields.com/resources/#actions" rel="noreferrer" target="_blank"><?php _e("Actions",'acf'); ?></a></li>
				<li><a href="http://www.advancedcustomfields.com/resources/#filters" rel="noreferrer" target="_blank"><?php _e("Filters",'acf'); ?></a></li>
				<li><a href="http://www.advancedcustomfields.com/resources/#how-to" rel="noreferrer" target="_blank"><?php _e("'How to' guides",'acf'); ?></a></li>
				<li><a href="http://www.advancedcustomfields.com/resources/#tutorials" rel="noreferrer" target="_blank"><?php _e("Tutorials",'acf'); ?></a></li>
			</ul>
		</div>
