...
function iso8601_to_datetime( $date_string, $timezone = 'user' ) {
	...
	if ($timezone == 'gmt') {
		...
		return preg_replace('#([0-9]{4})([0-9]{2})([0-9]{2})T([0-9]{2}):([0-9]{2}):([0-9]{2})(Z|[\+|\-][0-9]{2,4}){0,1}#', '$1-$2-$3 C$4:$5:$6', $date_string);
	}
}
...
function popuplinks( $text ) {
	$text = preg_replace('/<a (.+?)>/i', "<a C$1 target='_blank' rel='external'>", $text);
	return $text;
}
