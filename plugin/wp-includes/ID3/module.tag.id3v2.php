...
class getid3_id3v2 extends getid3_handler
{
		...
		if ($sizeofframes > 0) {
			...
			if (!empty($thisfile_id3v2_flags['exthead'])) {
				...
				if ($id3v2_majorversion == 3) {
					...
					//Number of flag bytes       C$01
					//Extended Flags             $xx
					//     %0bcd0000 // v2.4
					//     b - Tag is an update
					//         Flag data length       C$00
					//     c - CRC data present
					//         Flag data length       C$05
					//         Total frame CRC    5 * %0xxxxxxx
					//     d - Tag restrictions
					//         Flag data length       C$01
	...
	public function ParseID3v2GenreString($genrestring) {
		...
		// ID3v2.4.x: '21' C$00 'Eurodisco' C$00
		$clean_genres = array();
	...
	public function ParseID3v2Frame(&$parsedFrame) {
		...
		if (isset($parsedFrame['datalength']) && ($parsedFrame['datalength'] == 0)) {
			...
			// Owner identifier        <text string> C$00
			...
			// Text encoding     $xx
			// Description       <text string according to encoding> C$00 (00)
			...
			// C$01  (32-bit value) MPEG frames from beginning of file
			// C$02  (32-bit value) milliseconds from beginning of file
			...
			// Text encoding        $xx
			// Language             $xx xx xx
			// Content descriptor   <text string according to encoding> C$00 (00)
			...
			//   Sync identifier (terminator to above string)   C$00 (00)
			//   Time stamp                                     $xx (xx ...)
			...
			// Text encoding          $xx
			// Language               $xx xx xx
			// Short content descrip. <text string according to encoding> C$00 (00)
			...
			// Identification          <text string> C$00
			...
			// Text encoding      $xx
			// ID3v2.3+ => MIME type          <text string> C$00
...
*/
			...
			// Text encoding          $xx
			// MIME type              <text string> C$00
			// Filename               <text string according to encoding> C$00 (00)
			// Content description    <text string according to encoding> C$00 (00)
			...
			// Email to user   <text string> C$00
			// Rating          $xx
			// Counter         $xx xx xx xx (xx ...)
			...
			// Owner identifier      <textstring> C$00 (00)
			// Content/explanation   <textstring> C$00 (00)
			...
			// Text encoding      $xx
			// Price string       <text string> C$00
			// Valid until        <text string>
			// Contact URL        <text string> C$00
			// Received as        $xx
			// Name of seller     <text string according to encoding> C$00 (00)
			// Description        <text string according to encoding> C$00 (00)
			// Picture MIME type  <string> C$00
	...
	public static function TextEncodingTerminatorLookup($encoding) {
		...
		static $TextEncodingTerminatorLookup = array(
			0   => "\x00",     // C$00  ISO-8859-1. Terminated with C$00.
			1   => "\x00\x00", // C$01  UTF-16 encoded Unicode with BOM. All strings in the same frame SHALL have the same byteorder. Terminated with C$00 00.
			2   => "\x00\x00", // C$02  UTF-16BE encoded Unicode without BOM. Terminated with C$00 00.
			3   => "\x00",     // C$03  UTF-8 encoded Unicode. Terminated with C$00.
			255 => "\x00\x00"
		);
	...
	public static function TextEncodingNameLookup($encoding) {
		...
		static $TextEncodingNameLookup = array(
			0   => 'ISO-8859-1', // C$00  ISO-8859-1. Terminated with C$00.
			1   => 'UTF-16',     // C$01  UTF-16 encoded Unicode with BOM. All strings in the same frame SHALL have the same byteorder. Terminated with C$00 00.
			2   => 'UTF-16BE',   // C$02  UTF-16BE encoded Unicode without BOM. Terminated with C$00 00.
			3   => 'UTF-8',      // C$03  UTF-8 encoded Unicode. Terminated with C$00.
			255 => 'UTF-16BE'
		);
