...
# Arcade building and running dev
docker-compose exec --user=www-data -w /var/www/html/_arcade/src osca npm install
docker-compose exec --user=www-data -w /var/www/html/_arcade/src osca npm run build
