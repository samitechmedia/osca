	...
	<span class="inner">
		...
		<a href="<?php echo $partner['affiliate_link'] ?>" target="_blank" rel="nofollow noreferrer" class="add-info">
			<div class="carousel js-swiper js-review-swiper">
				...
				<span class="swiper-btn swiper-btn--prev js-review-swiper__prev" aria-label="previous">
				...
				<span class="swiper-btn swiper-btn--next js-review-swiper__next" aria-label="next">
					<svg class="icon icon--green-white" width="25" height="25" aria-hidden="true">
			...
			primary-btn--box-shadow-green"">Get your <?php echo $partner['bonusvalue']; ?> Bonus</span>
