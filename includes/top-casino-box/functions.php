...
function topCasinoBox($ctaButtonText){
    ...
    echo '<div class="bottom-box2">
                <a target="_blank" href="/go/spincasino/casino" rel="nofollow noreferrer">
                                <div class="hold-padd">
                                    <div class="img-left">
                                        <div class="logo-box-in">
                                            <div class="logo-wrap"><span href="#"><img alt="JackpotCity" class="lazy" src="/images/rings.svg" data-src="/images/logos/inner/jackpotcity-logo.png"></span></div>
