...
if ($detect->isMobile()) {
    header("Location: https://exclusivecredits.com/jpc/gl-jpc/?a=bfpadid93995"); //Default mobile link
}
else{
    if ($randomSplitNumber > 50) {
        header("Location: https://exclusivecredits.com/jpc/gl-jpc/?a=bfpadid93995"); //Default desktop link
    } else {
        header("Location: https://exclusivecredits.com/jpc/gl-jpc/?a=bfpadid93995"); //Test desktop link
    }
}
