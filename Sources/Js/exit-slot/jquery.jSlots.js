...
(function($){
    ...
    $.jSlots = function(el, options){
        ...
        // base.shuffle = function(o){
        //
        //     //for(var j, x, i = o.length; i; j = parseInt(Math.random() * i), x = o[--i], o[i] = o[j], o[j] = x);
        // 	if(base.attemptedSpins != 3){
        //         for (
        // 		 // initialisation: declare three variables
        // 		 var j, x, i = o.length, indCount = 0;
        ...
        base.Slot = function() {
            ...
            this.$el = $(this.el);
            // this.$el.html(base.shuffle(this.$el.children().get()));
            this.loopCount = 0;
            this.number = 0;
        ...
        base.Slot.prototype = {
            ...
            finish : function() {
                ...
                if (base.spinsCounter && base.spinsCounter % base.victoriousSpin === 0) {
                    endNum = base.random;
                }
        ...
        base.checkWinner = function(endNum, slot) {
            ...
            slot.number = endNum;
            base.currentImgs.push(slot.$el.children().get(endNum-1));
            ...
            if (base.doneCount === base.options.number) {
                ...
                if ( $.isFunction( base.options.onEnd ) ) {
                    base.options.onEnd(base.currentImgs);
                }
        ...
        base.playSlots = function() {
            ...
            base.random = Math.floor(1 + Math.random() * (base.liCount + 1 - 1));
