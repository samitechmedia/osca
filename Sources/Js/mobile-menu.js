(function ($) {
    ...
    var mobilemenu = {
        ...
        slicknavEngage: function () {
            ...
            $('.slicknav_btn').after('<a id="mobile-btn" href="/mobile"  style="outline: none;"><span id="mobile" class="slicknav_menutxt">Mobile</span></a><a id="real-money-btn" href="/real-money" tabindex="0"  style="outline: none;"><span id="real-money" class="slicknav_menutxt">Real Money</span></a>');
            console.log('engaged');
        },
