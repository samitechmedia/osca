<div id="result__area" class="row result__area js_gamesContainer js_lazyLoaderEventListener"
    <?php
    $isMobile = false;
    ...
    <div class="box col-12 col-sm-6 col-lg-4 col-xl-3">
        <div class="game-card">
            <div class="game-card__image">
                <a class="js_gamesContainerSingle" data-game-id="<?php echo $game['game_id']; ?>">
                    <div class="js_lazyLoader <?php echo $imageClassAddition?>"
